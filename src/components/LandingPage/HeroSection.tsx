...
//     <div
//       className={
//         "absolute flex items-center gap-2 sm:gap-3 rounded-2xl bg-white/90 backdrop-blur-md px-2.5 py-2 sm:px-3.5 sm:py-2.5 lg:px-5 lg:py-4 shadow-lg border border-white/50 " +
//         className
//       }
//     >
//       {children}
...
//   return (
//     <div className="bg-gray-50 px-4 sm:px-6 md:px-10 lg:px-1 py-8 sm:py-2 sm:pt-8 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-4 overflow-hidden">
//       {/* left section */}
//       <div className="w-full lg:w-1/2 lg:pl-20 flex flex-col items-center text-center lg:items-start lg:text-left">
//         <div className="flex flex-col gap-3 sm:gap-4 items-center lg:items-start">
//           <p className="text-primary bg-primary/10 backdrop-blur-md border border-primary/20 shadow-sm w-fit px-3 py-1.5 rounded-full text-xs sm:text-sm font-medium">
//             Your Health, Our Priority
//           </p>
//           <p className="text-2xl sm:text-4xl lg:text-5xl font-bold w-2/3 sm:w-full lg:w-[90%] leading-[1.15] sm:leading-[1.1]">
//             Quality care for a{" "}
//             <span className="text-primary">healthier you</span>
//           </p>
//           <p className="text-gray-500 text-sm sm:text-base lg:text-lg w-full lg:w-[90%]">
...
//           <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 bg-white rounded-2xl shadow-sm p-4 mt-8 w-full">
...
//       </div>
//       {/* right section */}
//       <div className="relative w-full lg:w-1/2 min-h-90 xs:min-h-[400px] sm:min-h-115 md:min-h-130 max-w-105 sm:max-w-130 md:max-w-[600px] shrink-0 flex items-center justify-center mx-auto">
//         {/* Background blob */}
//         <div
//           className="pointer-events-none absolute -right-24 sm:-right-32 md:-right-50 top-1/2 h-56 sm:h-96 md:h-125 w-56 sm:w-96 md:w-125 -translate-y-1/2 rounded-full opacity-90 blur-[2px]"
//           style={{
//             background:
...
//         />
//         <div
//           className="pointer-events-none absolute left-0 top-2 h-40 sm:h-60 md:h-75 w-28 sm:w-40 md:w-75 -translate-y-1/2 rounded-full opacity-90 blur-[2px]"
//           style={{
//             background:
//               "radial-gradient(circle at 40% 40%, rgba(16,185,129,0.18), rgba(16,185,129,0.05) 60%, transparent 85%)",
//           }}
//         />
//         <div
//           className="pointer-events-none absolute left-8 sm:left-16 md:left-20 top-3/4 size-40 sm:size-60 md:size-80 -translate-y-1/2 rounded-full blur-[2px]"
//           style={{
//             background:
//               "radial-gradient(circle at 40% 40%, rgba(16,185,129,0.18), rgba(16,185,129,0.05) 60%, transparent 85%)",
//           }}
//         />
//         <div className="relative w-full h-[360px] xs:h-[400px] sm:h-[460px] md:h-[520px]">
//           {/* Doctor image */}
//           <div className="absolute bottom-0 left-1/2 h-[300px] xs:h-[340px] sm:h-[380px] md:h-[460px] w-[220px] xs:w-[250px] sm:w-[280px] md:w-[360px] -translate-x-1/2 overflow-hidden">
//             <Image
...
//           <FloatingCard className="left-0 sm:left-2 md:left-12 lg:left-24 top-8 sm:top-16 md:top-28">
//             <span className="flex h-7 w-7 sm:h-9 sm:w-9 lg:h-11 lg:w-11 items-center justify-center rounded-full bg-emerald-50">
//               <FaHeadphones className="h-3.5 w-3.5 sm:h-4 sm:w-4 lg:h-5 lg:w-5 text-emerald-600" />
//             </span>
//             <span className="leading-tight">
//               <span className="block text-sm sm:text-base lg:text-lg font-bold text-slate-900">
//                 24/7
//               </span>
//               <span className="block text-[10px] sm:text-xs lg:text-sm text-slate-500">
//                 Support
//               </span>
//             </span>
//           </FloatingCard>
//           {/* Video Consultation — right middle */}
//           <FloatingCard className="right-0 sm:right-2 md:right-6 lg:right-2 top-24 sm:top-36 md:top-44">
//             <span className="flex h-7 w-7 sm:h-9 sm:w-9 lg:h-11 lg:w-11 items-center justify-center rounded-full bg-emerald-50">
//               <FaVideo className="h-3.5 w-3.5 sm:h-4 sm:w-4 lg:h-5 lg:w-5 text-emerald-600" />
//             </span>
//             <span className="leading-tight">
//               <span className="block text-sm sm:text-base lg:text-lg font-bold text-slate-900">
//                 Video
...
//           <FloatingCard className="right-0 sm:right-2 md:right-1 bottom-2 sm:bottom-8 md:bottom-16 flex-col items-start gap-1">
//             <div className="flex items-center gap-2">
...
//                     width={30}
//                     height={30}
//                     className="h-5 w-5 sm:h-6 sm:w-6 lg:h-8 lg:w-8 rounded-full border-2 border-white object-cover"
//                   />
//                 ))}
//               </div>
