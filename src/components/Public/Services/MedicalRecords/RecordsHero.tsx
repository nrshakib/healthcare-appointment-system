  ...
  return (
    <section className="overflow-hidden bg-linear-to-br from-[#baf5e2] via-[#eafff7] to-[#b8d9cf] pt-4 pb-10 sm:pt-6 sm:pb-12 lg:py-8">
      <div className="mx-auto w-full max-w-7xl lg:max-w-[90%] px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-3 md:gap-4 lg:gap-10">
          {/* Left Text Column */}
          <motion.div
          ...
          >
            ...
            >
              Access your health records securely, anytime, anywhere. Keep your
              health information secure, private & up-to-date.
            </motion.p>
          ...
          >
            <div className="relative w-52 min-[400px]:w-56 md:w-68 lg:w-72 xl:w-96 h-40 min-[400px]:h-48 md:h-52 lg:h-60 xl:h-72">
              <Image
                src="/images/services/medical-records-hero.png"
