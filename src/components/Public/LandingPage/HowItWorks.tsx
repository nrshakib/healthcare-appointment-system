        ...
        <div className="relative grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-10">
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                {!isLast && (
                  <div className="hidden sm:block absolute sm:top-5 lg:top-9 left-[calc(50%+80px)] right-[calc(-50%+44px)] border-t-2 border-dashed how-connector" />
                )}

                <div className="relative z-10 flex size-10 lg:size-18 items-center justify-center rounded-full how-icon-bg">
                  <Icon
                    className="text-xl lg:text-3xl how-icon"
                    strokeWidth={2}
                  />
                </div>
