        ...
        <div className="lg:col-span-5 p-8 lg:p-10 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-gray-200/80">
          <div>
            ...
            <p className="text-sm text-gray-400 mb-6">
              Sign in to manage your appointments, view medical records, and
              connect with top healthcare specialists.
            </p>
          </div>
                    ...
                    >
                      <ToggleButton
                        ...
                        sx={{
                          ...
                          gap: 1,
                          "&.Mui-selected": {
                            backgroundColor: "rgba(6, 131, 107, 0.12)",
                            color: "#06836B",
                            borderColor: "#06836B",
                          },
                          "&.Mui-selected:hover": {
                            backgroundColor: "rgba(6, 131, 107, 0.2)",
                          },
                        }}
                      >
                        <HiUser size={18} />
